...
class Evaluator:
    def GetPascalVOCMetrics(self,
        ...
        for c in classes:
            ...
            # create dictionary with amount of gts for each image_dict
    ...
    def PlotPrecisionRecallCurve(self,
        ...
        Args:
            ...
            savePath (optional): if informed, the plot will be saved as an image_dict in this path
    ...
    def _getAllIOUs(reference, detections):
        ...
        for d in detections:
            ...
            # Show blank image_dict with the bounding boxes
