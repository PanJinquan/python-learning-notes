...
class BoundingBoxes:
    ...
    # def drawAllBoundingBoxes(self, image_dict):
    #     for gt in self.getBoundingBoxesByType(BBType.GroundTruth):
    #         image_dict = add_bb_into_image(image_dict, gt ,color=(0,255,0))
    #     for det in self.getBoundingBoxesByType(BBType.Detected):
    #         image_dict = add_bb_into_image(image_dict, det ,color=(255,0,0))
    #     return image_dict
