# from utils import *
from lib.utils import CoordinatesType,BBType,BBFormat
...
class BoundingBox:
    def __init__(self,
        ...
        Args:
            ...
            coordinates (x,y,w,h) are absolute or relative to size of the image_dict. Default:'Absolute'.
            imgSize: (optional) 2D vector (width, height)=>(int, int) represents the size of the
            image_dict of the bounding box. If typeCoordinates is 'Relative', imgSize is required.
        ...
        if typeCoordinates == CoordinatesType.Relative and imgSize is None:
            raise IOError(
                'Parameter \'imgSize\' is required. It is necessary to inform the image_dict size.')
