...
if __name__ == "__main__":
    # NVR VAL faceDataset
    # dataset = '/media/dm/dm2/project/dataset/face_recognition/X4/X4_Face20_Crop/'
    ...
    pair_num=6000
    pair_filename = dataset + "nvr_pair_data6000.txt"
    ...
    # convert_image_to_bcolz(pair_filename, image_dir, save_dir=dataset + "NVR1", input_size=[112, 112])
