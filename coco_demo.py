...
class COCO_Instances(object):
    ...
    def getImgIds(self, catNms=[]):
        ...
        # 获得同时满足catNms的图片
        imgIds = self.coco.getImgIds(catIds=catIds)
        print("COCO image_dict num:{}".format(len(imgIds)))
        return imgIds
    ...
    def get_object_rects(self, imgIds, minarea=None, show=False):
        ...
        for img_ann in img_anns:
            ...
            if show:
                ...
                image_processing.show_image_rects_text("image_dict", I, rects, names)
        return info_list
    ...
    def get_object_mask(self, imgIds, show=True):
        ...
        for img_ann in img_anns:
            ...
            if show and np.sum(mask) != 0:
                ...
                image_processing.cv_show_image("object_mask", image)
    ...
    def annsToMask(self, anns):
        ...
        for ann in anns:
            ...
            if ann['segmentation']:
                ...
                print("no segmentation:category_id{}".format(id))
        return mask
    ...
    def get_object_keypoints(self, imgIds, show=False):
        ...
        for img_ann in img_anns:
            ...
            if show:
                ...
                I = io.imread(image_path)
                out_dir = "/media/dm/dm/git/python-learning-notes/data"
                out_path = os.path.join(out_dir, file_name)
                json_path = os.path.join(out_dir, file_name[:-len(".jpg")] + ".json")
                image_processing.save_image(out_path, I)
                bbox=image_processing.rects2bboxes(rects)
                file_processing.write_json_path(json_path, {"bbox": bbox})
...
if __name__ == "__main__":
    ...
    # annFile = "/media/dm/dm1/git/python-learning-notes/dataset/VOC/merge_coco_dataset.json"
