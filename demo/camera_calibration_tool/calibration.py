...
if __name__ == '__main__':
    ...
    parser.add_argument('-image_size', type=str, default="1920x1080", help='width*height of image_dict')
    parser.add_argument('-mode', type=str, default="calibrate", choices=['calibrate', 'rectify'],
                        help='to calibrate or rectify')
    parser.add_argument('-square', default=20, type=int, help='size of chessboard square, by mm')
    parser.add_argument('-corner', default="8x6", type=str, help='width*height of chessboard corner')
    ...
    if args.mode == 'calibrate':
        ...
        ret = calibrator.calibration(corner[1], corner[0], args.square)
        if ret:
