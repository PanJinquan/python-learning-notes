...
'''
# 内参矩阵
left_camera_matrix = np.array([[420.22189, 0., 316.41648],
                               [0., 419.96735, 218.34591],
                               [0., 0., 1.]])
# k1，k2，p1，p2，k3
left_distortion = np.array([[-0.01817, 0.06748, -0.00035, 0.00158, 0.00000]])

right_camera_matrix = np.array([[418.58943, 0., 326.57475],
                                [0., 418.65742, 216.69767],
                                [0., 0., 1.]])
right_distortion = np.array([[-0.01833, 0.05467, -0.00097, 0.00136, 0.00000]])

om = np.array([-0.00312, 0.00709, 0.00038])  # 旋转关系向量
R = cv2.Rodrigues(om)[0]  # 使用Rodrigues变换将om变换为R
print("om:{},\nR:{}".format(om, R))
# T = np.array([20.37103, 0.11011, -3.72620])  # 平移关系向量
